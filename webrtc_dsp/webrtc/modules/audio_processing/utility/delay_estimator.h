...
//                          WebRtc_CreateBinaryDelayEstimatorFarend().
//
void WebRtc_FreeBinaryDelayEstimatorFarend(
...
//
void WebRtc_InitBinaryDelayEstimatorFarend(
    BinaryDelayEstimatorFarend *self);
...
//                              -2    - Insufficient data for estimation.
//
int WebRtc_binary_last_delay(BinaryDelayEstimator *
                             self);
...
//                                      delay value.
float WebRtc_binary_last_delay_quality(
    BinaryDelayEstimator *self);
