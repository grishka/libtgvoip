...
void BufferOutputStream::WriteByte(
    unsigned char byte)
{
...
void BufferOutputStream::WriteInt32(int32_t i)
{
	...
	buffer[offset + 3] = (unsigned char)((i >> 24) &
	                                     0xFF);
	buffer[offset + 2] = (unsigned char)((i >> 16) &
	                                     0xFF);
...
void BufferOutputStream::WriteInt64(int64_t i)
{
	...
	buffer[offset + 7] = (unsigned char)((i >> 56) &
	                                     0xFF);
	buffer[offset + 6] = (unsigned char)((i >> 48) &
	                                     0xFF);
	buffer[offset + 5] = (unsigned char)((i >> 40) &
	                                     0xFF);
	buffer[offset + 4] = (unsigned char)((i >> 32) &
	                                     0xFF);
	buffer[offset + 3] = (unsigned char)((i >> 24) &
	                                     0xFF);
	buffer[offset + 2] = (unsigned char)((i >> 16) &
...
void BufferOutputStream::WriteBytes(
...
void BufferOutputStream::ExpandBufferIfNeeded(
    size_t need)
{
	if(offset + need > size) {
		if(need < 1024) {
